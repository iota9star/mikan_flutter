...
class TransitionContainer extends StatelessWidget {
  const TransitionContainer({
    ...
    this.shape = const RoundedSuperellipseBorder(borderRadius: BorderRadius.all(Radius.circular(16.0))),
  ...
  Widget build(BuildContext context) {
    ...
    return OpenContainer(
      closedColor: closedColor ?? theme.scaffoldBackgroundColor.withValues(alpha: 0.0),
