...
import 'package:mikan/core/widgets/md3e_header.dart';
...
Widget sliverGapH120WithNavBarHeight(BuildContext context) =>
    SliverToBoxAdapter(child: Gap(120.0 + context.navBarHeight));
