...
class Indicator {
  ...
  static Widget idle(
    ...
    return _build(
      SpinKitPumpingHeart(size: 18, color: color),
      "使点劲",
      height,
      top,
      bottom,
  ...
  static Widget can(
    ...
    return _build(
      SpinKitSquareCircle(size: 18, color: color),
      "松手",
      height,
      top,
      bottom,
  ...
  static Widget completed(
    ...
    return _build(
      SpinKitDualRing(size: 18, color: color),
      "加载完成",
      height,
      top,
      bottom,
  ...
  static Widget noMore(
    ...
    return _build(
      SpinKitDoubleBounce(size: 18, color: color),
      "没啦",
      height,
      top,
      bottom,
