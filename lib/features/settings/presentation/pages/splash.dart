...
import 'package:mikan/core/widgets/background.dart';
...
class _SplashPageState extends State<SplashPage> with TickerProviderStateMixin {
  ...
  void _setupAnimations() {
    _controller = AnimationController(duration: _splashDuration, vsync: this);
  ...
  void _navigateToHome() {
    ...
    _hasNavigated = true;
    Navigator.pushNamedAndRemoveUntil(context, Routes.index.name, (_) => false);
  }
  ...
  Widget _buildProgressIndicator() {
    return const PositionedDirectional(bottom: 100.0, child: ExpressiveLoadingIndicator());
  }
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return PositionedDirectional(
          ...
          child: Opacity(
            opacity: _fadeAnimation.value,
            child: PlaceholderText('点击屏幕马上进入', style: theme.textTheme.bodyMedium),
          ),
        );
      },
    );
        ...
        child: SizedBox.expand(
          child: BubbleBackground(
            ...
            child: Stack(
              ...
              children: [_buildLogo(), _buildProgressIndicator(), _buildSkipText()],
            ),
          ),
        ),
      ),
